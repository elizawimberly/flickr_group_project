    ...
    switch (action.type) {
        ...
        case ALBUMS_CREATE_SINGLE_ALBUM:
            ...
            newState.singleAlbumDetails = {...action.payload}
                ...
                newState.singleAlbumDetails.Photos = normalizeArray(action.payload.Photos);
            return newState
        ...
        case ALBUMS_READ_ALL_ALBUMS:
            ...
            newState.singleAlbumDetails = {...state.singleAlbumDetails}
                // deep copy nested structures: singleAlbumDetails.Photos
                let readAllAlbums_RevertPhotosArr =  Object.values(newState.singleAlbumDetails.Photos);
                let readAllAlbums_NewCopyPhotosObj = normalizeArray(readAllAlbums_RevertPhotosArr);
        ...
        case ALBUMS_DELETE_SINGLE_ALBUM:
            ...
            newState.singleAlbumDetails = {...state.singleAlbumDetails};
                // deep copy nested structures: singleAlbumDetails.Photos
                let deleteSingleAlbum_RevertPhotosArr =  Object.values(newState.singleAlbumDetails.Photos);
                let deleteSingleAlbum_NewCopyPhotosObj = normalizeArray(deleteSingleAlbum_RevertPhotosArr);
